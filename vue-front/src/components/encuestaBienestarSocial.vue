 <template>   <modalCargando v-if='cargando == true'>
</modalCargando><modalEncuestaCompleta v-if='encuestaCompleta>4'></modalEncuestaCompleta>
...
export default {
  ...
  data(){
    return{
      ...
      preguntasyvotos:[{pregunta:"¿Te sientes cómodo y seguro en el ambiente escolar?",votosnegativos:0,votospositivos:0,voto:null},
      {pregunta:"¿Te sientes apoyado/a por tus compañeros/as y profesores/as en el instituto?",votosnegativos:0,votospositivos:0,voto:null},
      {pregunta:"¿Sientes que tienes suficiente tiempo para descansar y equilibrar tus actividades escolares y personales?",votosnegativos:0,votospositivos:0,voto:null},
      {pregunta:"¿Te sientes motivado/a y comprometido/a con tu educación en el instituto?",votosnegativos:0,votospositivos:0,voto:null},
      {pregunta:"¿La carga de trabajo o presión académica por parte de el instituto es llevadera y soportable?",votosnegativos:0,votospositivos:0,voto:null}],
